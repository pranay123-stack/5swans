...
def GroupAddAverageAge(builder, averageAge): builder.PrependInt32Slot(1, averageAge, 0)
def GroupAddAverageWeight(builder, averageWeight): builder.PrependFloat32Slot(2, averageWeight, 0.0)
def GroupAddNames(builder, names): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(names), 0)
def GroupStartNamesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
